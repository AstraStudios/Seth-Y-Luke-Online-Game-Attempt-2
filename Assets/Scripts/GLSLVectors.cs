...
//////// IMPORTANT ////////
// api compatibilty needs to be updated to use dynamic keyword:
// Edit > Project Settings > Player > Other Settings
// Configuration > Api compatibility Level
// change to ".NET 4.x" or ".NET Framework"
///////////////////////////

namespace GLSLVectors {
    static class F // for factories 
    {
        //------------- UNPACK VECTORS+FLOATS TO ARRAY -------------
    
        // unpack
        // use:
        // unpack_vectors_and_floats_to_array(4,      5, new Vector2(3, 6), 2)
        //                                    |       |              |  |   |
        //                                    |       |              |  |   |
        // returns int[5, 3, 6, 2] (length of 4)      |              |  |   |
        //             |  |  |  +---------------------+              |  |   |
        //             |  |  +---------------------------------------+  |   |
        //             |  +---------------------------------------------+   |
        //             +----------------------------------------------------+
        private static float[] unpack_vectors_and_floats_to_array(int output_length, params dynamic[] inputs)
        {   
            float[] unpacked_values = new float[output_length];
            int unpacked_index = 0;
            try {
                for (int input_index = 0; input_index < inputs.Length; input_index++) 
                {
                    dynamic current = inputs[input_index];
                    Type type = current.GetType();
    
                    ///// unpack different types /////
                    // float/int
                    if (type == typeof(float) || type == typeof(int))
                        unpacked_values[unpacked_index] = (float)current;
                    // vector2
                    else if (type == typeof(Vector2))
                    {
                        unpacked_values[unpacked_index] = current.x;
                        unpacked_values[unpacked_index+1] = current.y;
                        unpacked_index += 1;
                    }
                    // vector3
                    else if (type == typeof(Vector3))
                    {
                        unpacked_values[unpacked_index]   = current.x;
                        unpacked_values[unpacked_index+1] = current.y;
                        unpacked_values[unpacked_index+2] = current.z;
                        unpacked_index += 2;
                    }
                    // vector4
                    else if (type == typeof(Vector4))
                    {
                        ...
                        unpacked_values[unpacked_index+1] = current.y;
                        unpacked_values[unpacked_index+2] = current.z;
                        unpacked_values[unpacked_index+3] = current.w;
                        unpacked_index += 3;
                    }
                    // uncaught
                    else
                        throw new ArgumentException("All unpacking inputs must be floats or vectors", current);
            ...
            {
                throw new ArgumentException($"The amount of unpacked input values must be no greater than {output_length}"); 
            }
    
            // not enough inputs
            if (unpacked_index < output_length)
            {
                // if single value input like vec4(1) (this is fine) 
                if (inputs.Length == 1) 
                    Array.Fill(unpacked_values, inputs[0]);
                else
                    throw new ArgumentException($"There must be at least {output_length} unpacked input values. You have {unpacked_index}");
            }
        ...
        //------------- VECTOR FACTORIES -------------
        // convert the array from unpack_vectors_and_floats_to_array to a vector
        // identical to glsl vector creation
        
        public static Vector2 vec2(params dynamic[] inputs)
        {
            float[] unpacked_values = unpack_vectors_and_floats_to_array(2, inputs);
            return new Vector2(unpacked_values[0], unpacked_values[1]);
        }
        public static Vector3 vec3(params dynamic[] inputs)
        {
            float[] unpacked_values = unpack_vectors_and_floats_to_array(3, inputs);
            return new Vector3(unpacked_values[0], unpacked_values[1], unpacked_values[2]);
        }
        public static Vector4 vec4(params dynamic[] inputs)
        {
            float[] unpacked_values = unpack_vectors_and_floats_to_array(4, inputs);
            return new Vector4(unpacked_values[0], unpacked_values[1], unpacked_values[2], unpacked_values[3]);
        }
	...
	static class Vector2Swizzles {
		...
		// setters
		public static void xy(this ref Vector2 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.x = b.x; a.y = b.y; }
		public static void yx(this ref Vector2 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.y = b.x; a.x = b.y; }
		// swizzles of size 3
		// getters
	...
	static class Vector3Swizzles {
		...
		// setters
		public static void xy(this ref Vector3 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.x = b.x; a.y = b.y; }
		public static void xz(this ref Vector3 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.x = b.x; a.z = b.y; }
		public static void yx(this ref Vector3 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.y = b.x; a.x = b.y; }
		public static void yz(this ref Vector3 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.y = b.x; a.z = b.y; }
		public static void zx(this ref Vector3 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.z = b.x; a.x = b.y; }
		public static void zy(this ref Vector3 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.z = b.x; a.y = b.y; }
		// swizzles of size 3
		// getters
		...
		// setters
		public static void xyz(this ref Vector3 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.x = b.x; a.y = b.y; a.z = b.z; }
		public static void xzy(this ref Vector3 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.x = b.x; a.z = b.y; a.y = b.z; }
		public static void yxz(this ref Vector3 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.y = b.x; a.x = b.y; a.z = b.z; }
		public static void yzx(this ref Vector3 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.y = b.x; a.z = b.y; a.x = b.z; }
		public static void zxy(this ref Vector3 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.z = b.x; a.x = b.y; a.y = b.z; }
		public static void zyx(this ref Vector3 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.z = b.x; a.y = b.y; a.x = b.z; }
		// swizzles of size 4
		// getters
	...
	static class Vector4Swizzles {
		...
		// setters
		public static void xy(this ref Vector4 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.x = b.x; a.y = b.y; }
		public static void xz(this ref Vector4 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.x = b.x; a.z = b.y; }
		public static void xw(this ref Vector4 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.x = b.x; a.w = b.y; }
		public static void yx(this ref Vector4 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.y = b.x; a.x = b.y; }
		public static void yz(this ref Vector4 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.y = b.x; a.z = b.y; }
		public static void yw(this ref Vector4 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.y = b.x; a.w = b.y; }
		public static void zx(this ref Vector4 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.z = b.x; a.x = b.y; }
		public static void zy(this ref Vector4 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.z = b.x; a.y = b.y; }
		public static void zw(this ref Vector4 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.z = b.x; a.w = b.y; }
		public static void wx(this ref Vector4 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.w = b.x; a.x = b.y; }
		public static void wy(this ref Vector4 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.w = b.x; a.y = b.y; }
		public static void wz(this ref Vector4 a, params dynamic[] inputs) { Vector2 b = F.vec2(inputs); a.w = b.x; a.z = b.y; }
		// swizzles of size 3
		// getters
		...
		// setters
		public static void xyz(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.x = b.x; a.y = b.y; a.z = b.z; }
		public static void xyw(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.x = b.x; a.y = b.y; a.w = b.z; }
		public static void xzy(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.x = b.x; a.z = b.y; a.y = b.z; }
		public static void xzw(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.x = b.x; a.z = b.y; a.w = b.z; }
		public static void xwy(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.x = b.x; a.w = b.y; a.y = b.z; }
		public static void xwz(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.x = b.x; a.w = b.y; a.z = b.z; }
		public static void yxz(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.y = b.x; a.x = b.y; a.z = b.z; }
		public static void yxw(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.y = b.x; a.x = b.y; a.w = b.z; }
		public static void yzx(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.y = b.x; a.z = b.y; a.x = b.z; }
		public static void yzw(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.y = b.x; a.z = b.y; a.w = b.z; }
		public static void ywx(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.y = b.x; a.w = b.y; a.x = b.z; }
		public static void ywz(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.y = b.x; a.w = b.y; a.z = b.z; }
		public static void zxy(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.z = b.x; a.x = b.y; a.y = b.z; }
		public static void zxw(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.z = b.x; a.x = b.y; a.w = b.z; }
		public static void zyx(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.z = b.x; a.y = b.y; a.x = b.z; }
		public static void zyw(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.z = b.x; a.y = b.y; a.w = b.z; }
		public static void zwx(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.z = b.x; a.w = b.y; a.x = b.z; }
		public static void zwy(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.z = b.x; a.w = b.y; a.y = b.z; }
		public static void wxy(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.w = b.x; a.x = b.y; a.y = b.z; }
		public static void wxz(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.w = b.x; a.x = b.y; a.z = b.z; }
		public static void wyx(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.w = b.x; a.y = b.y; a.x = b.z; }
		public static void wyz(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.w = b.x; a.y = b.y; a.z = b.z; }
		public static void wzx(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.w = b.x; a.z = b.y; a.x = b.z; }
		public static void wzy(this ref Vector4 a, params dynamic[] inputs) { Vector3 b = F.vec3(inputs); a.w = b.x; a.z = b.y; a.y = b.z; }
		// swizzles of size 4
		// getters
		...
		// setters
		public static void xyzw(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.x = b.x; a.y = b.y; a.z = b.z; a.w = b.w; }
		public static void xywz(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.x = b.x; a.y = b.y; a.w = b.z; a.z = b.w; }
		public static void xzyw(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.x = b.x; a.z = b.y; a.y = b.z; a.w = b.w; }
		public static void xzwy(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.x = b.x; a.z = b.y; a.w = b.z; a.y = b.w; }
		public static void xwyz(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.x = b.x; a.w = b.y; a.y = b.z; a.z = b.w; }
		public static void xwzy(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.x = b.x; a.w = b.y; a.z = b.z; a.y = b.w; }
		public static void yxzw(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.y = b.x; a.x = b.y; a.z = b.z; a.w = b.w; }
		public static void yxwz(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.y = b.x; a.x = b.y; a.w = b.z; a.z = b.w; }
		public static void yzxw(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.y = b.x; a.z = b.y; a.x = b.z; a.w = b.w; }
		public static void yzwx(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.y = b.x; a.z = b.y; a.w = b.z; a.x = b.w; }
		public static void ywxz(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.y = b.x; a.w = b.y; a.x = b.z; a.z = b.w; }
		public static void ywzx(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.y = b.x; a.w = b.y; a.z = b.z; a.x = b.w; }
		public static void zxyw(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.z = b.x; a.x = b.y; a.y = b.z; a.w = b.w; }
		public static void zxwy(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.z = b.x; a.x = b.y; a.w = b.z; a.y = b.w; }
		public static void zyxw(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.z = b.x; a.y = b.y; a.x = b.z; a.w = b.w; }
		public static void zywx(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.z = b.x; a.y = b.y; a.w = b.z; a.x = b.w; }
		public static void zwxy(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.z = b.x; a.w = b.y; a.x = b.z; a.y = b.w; }
		public static void zwyx(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.z = b.x; a.w = b.y; a.y = b.z; a.x = b.w; }
		public static void wxyz(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.w = b.x; a.x = b.y; a.y = b.z; a.z = b.w; }
		public static void wxzy(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.w = b.x; a.x = b.y; a.z = b.z; a.y = b.w; }
		public static void wyxz(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.w = b.x; a.y = b.y; a.x = b.z; a.z = b.w; }
		public static void wyzx(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.w = b.x; a.y = b.y; a.z = b.z; a.x = b.w; }
		public static void wzxy(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.w = b.x; a.z = b.y; a.x = b.z; a.y = b.w; }
		public static void wzyx(this ref Vector4 a, params dynamic[] inputs) { Vector4 b = F.vec4(inputs); a.w = b.x; a.z = b.y; a.y = b.z; a.x = b.w; }
	}
